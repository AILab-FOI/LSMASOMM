"""
__OrganizationalKnArt.py_____________________________________________________

Automatically generated AToM3 syntactic object (DO NOT MODIFY DIRECTLY)
Author: bogdan
Modified: Mon Jun 13 14:21:22 2016
...
from graph_OrganizationalKnArt import *
class OrganizationalKnArt(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_OrganizationalKnArt
   ...
   def clone(self):
      cloneObject = OrganizationalKnArt( self.parent )
