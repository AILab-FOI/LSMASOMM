"""
__graph_isPartOf.py___________________________________________________________

Automatically generated LINK for entity isPartOf
...
class graph_isPartOf(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le.FirstLink.decoration.setValue( ('isPartOf_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('isPartOf_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('isPartOf_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('isPartOf_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('isPartOf_2ndLink', self.le.SecondLink))
