"""
__graph_hasObjective.py___________________________________________________________

Automatically generated LINK for entity hasObjective
...
class graph_hasObjective(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le.FirstLink.decoration.setValue( ('hasObjective_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('hasObjective_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('hasObjective_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('hasObjective_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('hasObjective_2ndLink', self.le.SecondLink))
