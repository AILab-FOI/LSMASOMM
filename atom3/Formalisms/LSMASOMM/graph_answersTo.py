"""
__graph_answersTo.py___________________________________________________________

Automatically generated LINK for entity answersTo
...
class graph_answersTo(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le.FirstLink.decoration.setValue( ('answersTo_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('answersTo_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('answersTo_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('answersTo_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('answersTo_2ndLink', self.le.SecondLink))
