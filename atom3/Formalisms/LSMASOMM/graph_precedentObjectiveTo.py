"""
__graph_precedentObjectiveTo.py___________________________________________________________

Automatically generated LINK for entity precedentObjectiveTo
...
class graph_precedentObjectiveTo(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "precedentObjectiveTo")
      ...
      self.le.FirstLink.decoration.setValue( ('precedentObjectiveTo_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('precedentObjectiveTo_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('precedentObjectiveTo_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('precedentObjectiveTo_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('precedentObjectiveTo_2ndLink', self.le.SecondLink))
