"""
__graph_canStartProcess.py___________________________________________________________

Automatically generated LINK for entity canStartProcess
...
class graph_canStartProcess(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "canStartProcess")
      ...
      self.le.FirstLink.decoration.setValue( ('canStartProcess_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('canStartProcess_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('canStartProcess_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('canStartProcess_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('canStartProcess_2ndLink', self.le.SecondLink))
