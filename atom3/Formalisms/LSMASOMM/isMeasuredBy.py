"""
__isMeasuredBy.py_____________________________________________________
...
from graph_isMeasuredBy import *
class isMeasuredBy(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_isMeasuredBy
      ...
      self.directEditing = []
   def clone(self):
      cloneObject = isMeasuredBy( self.parent )
