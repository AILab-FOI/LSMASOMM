"""
__precedentObjectiveTo.py_____________________________________________________

Automatically generated AToM3 syntactic object (DO NOT MODIFY DIRECTLY)
Author: bogdan
Modified: Thu Feb  1 19:14:24 2018
...
from graph_precedentObjectiveTo import *
class precedentObjectiveTo(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_precedentObjectiveTo
      ...
      self.directEditing = []
   def clone(self):
      cloneObject = precedentObjectiveTo( self.parent )
