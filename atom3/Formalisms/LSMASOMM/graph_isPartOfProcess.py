"""
__graph_isPartOfProcess.py___________________________________________________________

Automatically generated LINK for entity isPartOfProcess
...
class graph_isPartOfProcess(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "isPartOfProcess")
      ...
      self.le.FirstLink.decoration.setValue( ('isPartOfProcess_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('isPartOfProcess_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('isPartOfProcess_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('isPartOfProcess_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('isPartOfProcess_2ndLink', self.le.SecondLink))
