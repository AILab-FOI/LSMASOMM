"""
__graph_canNotCommunicateWith.py___________________________________________________________

Automatically generated LINK for entity canNotCommunicateWith
...
class graph_canNotCommunicateWith(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "canNotCommunicateWith")
      ...
      self.le.FirstLink.decoration.setValue( ('canNotCommunicateWith_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('canNotCommunicateWith_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('canNotCommunicateWith_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('canNotCommunicateWith_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('canNotCommunicateWith_2ndLink', self.le.SecondLink))
