"""
__graph_canAccessKnArt.py___________________________________________________________

Automatically generated LINK for entity canAccessKnArt
...
class graph_canAccessKnArt(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "canAccessKnArt")
      ...
      self.le.FirstLink.decoration.setValue( ('canAccessKnArt_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('canAccessKnArt_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('canAccessKnArt_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('canAccessKnArt_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('canAccessKnArt_2ndLink', self.le.SecondLink))
