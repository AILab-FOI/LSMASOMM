...
def LSMASOMM_MDL(self, rootNode, CD_ClassDiagramsV3RootNode=None):
    ...
    if self.genGraphics:
       new_obj = graph_CD_Class3(380.0,1080.0,self.obj28)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Class3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    ...
    if self.genGraphics:
       new_obj = graph_CD_Class3(660.0,960.0,self.obj30)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Class3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    ...
    if self.genGraphics:
       new_obj = graph_CD_Class3(1220.0,1000.0,self.obj31)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Class3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.2359375000000001, 1.0454545454545454]
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(1386.9955984,65.809726225,self.obj35)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(1126.462784,833.548234957,self.obj38)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    ...
    if self.genGraphics:
       ...
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.1620000000000001, 1.6258064516129034]
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(1028.0,327.0,self.obj41)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(887.0,133.0,self.obj42)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.3548387096774195]
...
(self.obj26,self.obj38,[1241.14453125, 515.5737704918033, 1017.8287423035672, 504.3266545159663, 1126.462784, 833.548234957],"true", 3),
...
(self.obj36,self.obj27,[971.7601868, 527.680947659, 975.67812505129, 573.9601284363068, 832.921875, 620.5901639344263],"true", 3) )
    ...
    self.drawConnections(
(self.obj37,self.obj28,[532.161248615, 913.001803815, 494.1593669760688, 981.6469579482074, 498.8125, 1053.4918032786886],"true", 3) )
    # Connections for obj38 (graphObject_: Obj15) named canAccessKnArt
    self.drawConnections(
(self.obj38,self.obj30,[1126.462784, 833.548234957, 1148.2678325033444, 899.9439489105719, 895.5703125, 1002.4545454545455],"true", 3),
(self.obj38,self.obj31,[1126.462784, 833.548234957, 1053.4035107781324, 935.4763808302594, 1220.7421875, 1042.4545454545455],"true", 3) )
