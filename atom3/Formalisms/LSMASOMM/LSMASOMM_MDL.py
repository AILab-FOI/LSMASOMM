...
Author: bogdan
Modified: Mon Sep 26 16:26:21 2016
...
def LSMASOMM_MDL(self, rootNode, CD_ClassDiagramsV3RootNode=None):
    ...
    if self.genGraphics:
       ...
       new_obj.layConstraints['scale'] = [1.11015625, 2.581967213114754]
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_CD_Class3(620.0,340.0,self.obj27)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Class3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['Text Scale'] = 0.85
       new_obj.layConstraints['scale'] = [1.115625, 3.098360655737705]
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_CD_Class3(40.0,340.0,self.obj32)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Class3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0454545454545454]
...
(self.obj26,self.obj36,[1241.14453125, 465.8114754098361, 967.8422485527899, 481.40176688146084, 971.7601868, 527.680947659],"true", 3),
(self.obj26,self.obj38,[1241.14453125, 465.8114754098361, 997.8287423035672, 492.3266545159663, 1106.462784, 821.548234957],"true", 3),
(self.obj26,self.obj44,[1241.14453125, 323.8032786885246, 1130.0, 231.0, 1113.0, 79.0], 0, 3) )
    ...
    self.drawConnections(
(self.obj27,self.obj37,[660.0, 775.0, 541.1631302538499, 883.356649681594, 503.161248615, 952.001803815],"true", 3),
(self.obj27,self.obj38,[832.921875, 713.0327868852459, 1023.5805784296024, 714.1457487347751, 1106.462784, 821.548234957],"true", 3),
(self.obj27,self.obj40,[620.953125, 551.9180327868853, 522.0012232889502, 553.7739542825374, 436.73445957, 632.859445861],"true", 3),
(self.obj27,self.obj41,[832.921875, 465.1639344262295, 1044.0, 340.0], 0, 2),
(self.obj27,self.obj42,[793.875, 341.22950819672127, 933.0, 176.0], 0, 2),
(self.obj27,self.obj43,[620.953125, 465.1639344262295, 470.4921875, 411.163934426], 0, 2),
(self.obj27,self.obj45,[660.0, 341.22950819672127, 675.0, 160.0],"true", 2) )
...
(self.obj31,self.obj47,[1240.7421875, 1186.090909090909, 1136.90914946, 1358.75085967],"true", 2) )
    ...
    self.drawConnections(
(self.obj33,self.obj48,[139.75, 629.4918032786885, 152.858254695, 586.846159545],"true", 2),
(self.obj33,self.obj39,[139.75, 803.0, 131.94404651894035, 946.9122308488277, 131.944046519, 946.91223085],"true", 3) )
    ...
    self.drawConnections(
(self.obj34,self.obj40,[324.0, 283.0, 333.0, 453.0, 436.73445957, 632.859445861],"true", 3) )
...
(self.obj35,self.obj26,[1387.9955984, 65.80972622499999, 1387.9955983980042, 65.8097262245276, 1368.8125, 220.52459016393442],"true", 3) )
    ...
    self.drawConnections(
(self.obj36,self.obj27,[971.7601868, 527.680947659, 975.67812505129, 573.9601284363068, 832.921875, 551.9180327868853],"true", 3) )
...
(self.obj40,self.obj33,[436.73445957, 632.859445861, 351.4676958509182, 711.9449374392455, 281.65625, 698.8950819672131],"true", 3) )
    ...
    self.drawConnections(
(self.obj41,self.obj27,[1044.0, 340.0, 832.921875, 465.1639344262295], 0, 2) )
    # Connections for obj42 (graphObject_: Obj23) named answersToRole
    self.drawConnections(
(self.obj42,self.obj27,[933.0, 176.0, 793.875, 341.22950819672127], 0, 2) )
    # Connections for obj43 (graphObject_: Obj25) named canStartProcess
    self.drawConnections(
(self.obj43,self.obj34,[470.4921875, 411.163934426, 471.65625, 283.0], 0, 2) )
...
(self.obj44,self.obj26,[1113.0, 79.0, 1279.0, 145.0, 1280.0, 220.52459016393442], 0, 3) )
    ...
    self.drawConnections(
(self.obj45,self.obj27,[675.0, 160.0, 660.0, 341.22950819672127],"true", 2) )
...
(self.obj47,self.obj29,[1136.90914946, 1358.75085967, 1153.0, 1255.0],"true", 2) )
    ...
    self.drawConnections(
(self.obj48,self.obj32,[152.858254695, 586.846159545, 156.0, 487.0],"true", 2) )
