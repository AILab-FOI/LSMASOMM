"""
__isPartOf.py_____________________________________________________

Automatically generated AToM3 syntactic object (DO NOT MODIFY DIRECTLY)
Author: bogdan
Modified: Fri Jul  8 20:59:42 2016
...
from graph_isPartOf import *
class isPartOf(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_isPartOf
      ...
      self.directEditing = []
   def clone(self):
      cloneObject = isPartOf( self.parent )
