"""
__graph_hasOrgGoal.py___________________________________________________________

Automatically generated LINK for entity hasOrgGoal
...
class graph_hasOrgGoal(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le.FirstLink.decoration.setValue( ('hasOrgGoal_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('hasOrgGoal_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('hasOrgGoal_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('hasOrgGoal_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('hasOrgGoal_2ndLink', self.le.SecondLink))
