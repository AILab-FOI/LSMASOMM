...
Author: bogdan
Modified: Thu Feb  1 19:22:26 2018
...
def LSMASOMM_MDL(self, rootNode, CD_ClassDiagramsV3RootNode=None):
    ...
    if self.genGraphics:
       new_obj = graph_CD_Class3(10.0,290.0,self.obj32)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Class3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.0, 1.0454545454545454]
    ...
    if self.genGraphics:
       ...
       self.UMLmodel.addtag_withtag("CD_Class3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
       new_obj.layConstraints['scale'] = [1.44921875, 2.6852459016393446]
    else: new_obj = None
    ...
    # Graphical_Appearance
    self.obj51.Graphical_Appearance.setValue( ('Association_12', self.obj51))
    self.obj51.Graphical_Appearance.linkInfo=linkEditor(self,self.obj51.Graphical_Appearance.semObject, "Association_12")
    ...
    self.obj51.Graphical_Appearance.linkInfo.FirstLink.decoration.setValue( ('Association_12_1stLink', self.obj51.Graphical_Appearance.linkInfo.FirstLink))
    ...
    self.obj51.Graphical_Appearance.linkInfo.FirstSegment.decoration.setValue( ('Association_12_1stSegment', self.obj51.Graphical_Appearance.linkInfo.FirstSegment))
    ...
    self.obj51.Graphical_Appearance.linkInfo.Center.setValue( ('Association_12_Center', self.obj51.Graphical_Appearance.linkInfo))
    ...
    self.obj51.Graphical_Appearance.linkInfo.SecondSegment.decoration.setValue( ('Association_12_2ndSegment', self.obj51.Graphical_Appearance.linkInfo.SecondSegment))
    ...
    self.obj51.Graphical_Appearance.linkInfo.SecondLink.decoration.setValue( ('Association_12_2ndLink', self.obj51.Graphical_Appearance.linkInfo.SecondLink))
    ...
    # name
    self.obj51.name.setValue('precedentObjectiveTo')
    ...
    if self.genGraphics:
       new_obj = graph_CD_Association3(333.0,963.0,self.obj51)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Association3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    ...
    if self.genGraphics:
       new_obj = graph_CD_Inheritance3(900.21888986,907.92763695,self.obj47)
       new_obj.DrawObject(self.UMLmodel)
    ...
    if self.genGraphics:
       new_obj = graph_CD_Inheritance3(900.90914946,1003.75085967,self.obj48)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Inheritance3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_CD_Inheritance3(151.858254695,480.846159545,self.obj49)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Inheritance3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
    ...
    if self.genGraphics:
       new_obj = graph_CD_Inheritance3(86.466796875,272.786885246,self.obj50)
       new_obj.DrawObject(self.UMLmodel)
       self.UMLmodel.addtag_withtag("CD_Inheritance3", new_obj.tag)
       new_obj.layConstraints = dict() # Graphical Layout Constraints 
    else: new_obj = None
...
(self.obj28,self.obj40,[498.8125, 690.0, 541.73445957, 858.859445861],"true", 2) )
    ...
    self.drawConnections(
(self.obj30,self.obj47,[927.7421875, 911.0909090909091, 900.21888986, 907.92763695], 0, 2) )
    # Connections for obj31 (graphObject_: Obj5) named IndividualKnArt
    self.drawConnections(
(self.obj31,self.obj48,[927.7421875, 1016.7272727272727, 900.90914946, 1003.75085967],"true", 2) )
    # Connections for obj32 (graphObject_: Obj6) named Strategy
    self.drawConnections(
 )
    # Connections for obj33 (graphObject_: Obj7) named Objective
    self.drawConnections(
(self.obj33,self.obj49,[177.9375, 463.06557377049177, 151.858254695, 480.846159545],"true", 2),
(self.obj33,self.obj39,[156.5, 781.0, 131.94404651894035, 946.9122308488277, 131.944046519, 946.91223085],"true", 3),
(self.obj33,self.obj51,[235.90625, 839.0, 333.0, 963.0],"true", 2) )
...
(self.obj34,self.obj50,[103.21875, 242.0, 86.466796875, 272.786885246],"true", 2) )
...
(self.obj46,self.obj34,[442.0, 278.0, 244.72265625, 208.95081967213116],"true", 2) )
    # Connections for obj51 (graphObject_: Obj41) named precedentObjectiveTo
    self.drawConnections(
(self.obj51,self.obj33,[333.0, 963.0, 235.90625, 839.0],"true", 2) )
    # Connections for obj47 (graphObject_: Obj33) of type CD_Inheritance3
    self.drawConnections(
(self.obj47,self.obj29,[900.21888986, 907.92763695, 860.0, 908.4545454545455], 0, 2) )
    # Connections for obj48 (graphObject_: Obj35) of type CD_Inheritance3
    self.drawConnections(
(self.obj48,self.obj29,[900.90914946, 1003.75085967, 860.0, 992.0909090909091],"true", 2) )
    # Connections for obj49 (graphObject_: Obj37) of type CD_Inheritance3
    self.drawConnections(
(self.obj49,self.obj32,[151.858254695, 480.846159545, 166.0, 437.0],"true", 2) )
    # Connections for obj50 (graphObject_: Obj39) of type CD_Inheritance3
    self.drawConnections(
(self.obj50,self.obj32,[86.466796875, 272.786885246, 86.0, 290.6363636363636],"true", 2) )
