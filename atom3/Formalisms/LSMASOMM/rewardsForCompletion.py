"""
__rewardsForCompletion.py_____________________________________________________
...
from graph_rewardsForCompletion import *
class rewardsForCompletion(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_rewardsForCompletion
      ...
      self.directEditing = []
   def clone(self):
      cloneObject = rewardsForCompletion( self.parent )
