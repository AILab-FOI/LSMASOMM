"""
__isPartOfOrgUnit.py_____________________________________________________
...
class isPartOfOrgUnit(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_isPartOfOrgUnit
