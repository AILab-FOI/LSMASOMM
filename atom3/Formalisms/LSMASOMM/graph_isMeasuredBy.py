"""
__graph_isMeasuredBy.py___________________________________________________________

Automatically generated LINK for entity isMeasuredBy
...
class graph_isMeasuredBy(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le.FirstLink.decoration.setValue( ('isMeasuredBy_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('isMeasuredBy_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('isMeasuredBy_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('isMeasuredBy_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('isMeasuredBy_2ndLink', self.le.SecondLink))
