"""
__graph_hasActions.py___________________________________________________________

Automatically generated LINK for entity hasActions
...
class graph_hasActions(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le.FirstLink.decoration.setValue( ('hasActions_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('hasActions_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('hasActions_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('hasActions_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('hasActions_2ndLink', self.le.SecondLink))
