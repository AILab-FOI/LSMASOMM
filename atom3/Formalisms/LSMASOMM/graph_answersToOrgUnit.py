"""
__graph_answersToOrgUnit.py___________________________________________________________

Automatically generated LINK for entity answersToOrgUnit
...
class graph_answersToOrgUnit(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "answersToOrgUnit")
      ...
      self.le.FirstLink.decoration.setValue( ('answersToOrgUnit_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('answersToOrgUnit_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('answersToOrgUnit_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('answersToOrgUnit_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('answersToOrgUnit_2ndLink', self.le.SecondLink))
