"""
__graph_answersToRole.py___________________________________________________________

Automatically generated LINK for entity answersToRole
...
class graph_answersToRole(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le.FirstLink.decoration.setValue( ('answersToRole_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('answersToRole_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('answersToRole_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('answersToRole_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('answersToRole_2ndLink', self.le.SecondLink))
