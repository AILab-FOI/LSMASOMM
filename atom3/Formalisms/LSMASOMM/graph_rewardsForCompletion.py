"""
__graph_rewardsForCompletion.py___________________________________________________________

Automatically generated LINK for entity rewardsForCompletion
...
class graph_rewardsForCompletion(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "rewardsForCompletion")
      ...
      self.le.FirstLink.decoration.setValue( ('rewardsForCompletion_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('rewardsForCompletion_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('rewardsForCompletion_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('rewardsForCompletion_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('rewardsForCompletion_2ndLink', self.le.SecondLink))
