"""
__hasOrgGoal.py_____________________________________________________

Automatically generated AToM3 syntactic object (DO NOT MODIFY DIRECTLY)
Author: bogdan
Modified: Tue Jun 14 17:20:03 2016
...
from graph_hasOrgGoal import *
class hasOrgGoal(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_hasOrgGoal
      ...
      self.directEditing = []
   def clone(self):
      cloneObject = hasOrgGoal( self.parent )
