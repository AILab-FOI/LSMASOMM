"""
__graph_isPartOfRole.py___________________________________________________________

Automatically generated LINK for entity isPartOfRole
...
class graph_isPartOfRole(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le.FirstLink.decoration.setValue( ('isPartOfRole_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('isPartOfRole_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('isPartOfRole_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('isPartOfRole_2ndSegment', self.le.SecondSegment))
      self.le.SecondSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],0,0)
      ...
      self.le.SecondLink.decoration.setValue( ('isPartOfRole_2ndLink', self.le.SecondLink))
