"""
__graph_canHaveRole.py___________________________________________________________

Automatically generated LINK for entity canHaveRole
...
class graph_canHaveRole(graphLink):
   ...
   def __init__(self, xc, yc, semObject = None ):
      ...
      self.le.FirstLink.decoration.setValue( ('canHaveRole_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('canHaveRole_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('canHaveRole_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('canHaveRole_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('canHaveRole_2ndLink', self.le.SecondLink))
