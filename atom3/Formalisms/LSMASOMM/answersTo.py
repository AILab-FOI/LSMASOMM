"""
__answersTo.py_____________________________________________________
...
from graph_answersTo import *
class answersTo(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_answersTo
      ...
      self.directEditing = []
   def clone(self):
      cloneObject = answersTo( self.parent )
