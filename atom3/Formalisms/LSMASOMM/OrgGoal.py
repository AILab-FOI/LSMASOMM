"""
__OrgGoal.py_____________________________________________________
...
from graph_OrgGoal import *
class OrgGoal(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_OrgGoal
   ...
   def clone(self):
      cloneObject = OrgGoal( self.parent )
