"""
__graph_isPartOfOrgUnit.py___________________________________________________________

Automatically generated LINK for entity isPartOfOrgUnit
...
class graph_isPartOfOrgUnit(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "isPartOfOrgUnit")
      ...
      self.le.FirstLink.decoration.setValue( ('isPartOfOrgUnit_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('isPartOfOrgUnit_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('isPartOfOrgUnit_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('isPartOfOrgUnit_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('isPartOfOrgUnit_2ndLink', self.le.SecondLink))
