"""
__IndividualKnArt.py_____________________________________________________
...
class IndividualKnArt(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_IndividualKnArt
   ...
   def clone(self):
      cloneObject = IndividualKnArt( self.parent )
