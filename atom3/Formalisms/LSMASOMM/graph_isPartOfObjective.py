"""
__graph_isPartOfObjective.py___________________________________________________________

Automatically generated LINK for entity isPartOfObjective
...
class graph_isPartOfObjective(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "isPartOfObjective")
      ...
      self.le.FirstLink.decoration.setValue( ('isPartOfObjective_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('isPartOfObjective_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('isPartOfObjective_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('isPartOfObjective_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('isPartOfObjective_2ndLink', self.le.SecondLink))
