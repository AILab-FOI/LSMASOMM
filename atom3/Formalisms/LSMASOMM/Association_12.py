"""
__Association_12.py_____________________________________________________

Automatically generated AToM3 syntactic object (DO NOT MODIFY DIRECTLY)
Author: bogdan
Modified: Fri Feb  2 01:41:54 2018
...
from graph_Association_12 import *
class Association_12(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_Association_12
      ...
      self.directEditing = []
   def clone(self):
      cloneObject = Association_12( self.parent )
