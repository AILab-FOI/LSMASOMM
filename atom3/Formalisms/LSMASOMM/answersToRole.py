"""
__answersToRole.py_____________________________________________________
...
from graph_answersToRole import *
class answersToRole(ASGNode, ATOM3Type):

   def __init__(self, parent = None):
      ASGNode.__init__(self)
      ATOM3Type.__init__(self)
      self.graphClass_ = graph_answersToRole
