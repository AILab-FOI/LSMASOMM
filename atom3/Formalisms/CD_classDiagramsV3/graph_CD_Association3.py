"""
__graph_CD_Association3.py___________________________________________________________

Automatically generated LINK for entity CD_Association3
...
class graph_CD_Association3(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "CD_Association3")
      ...
      self.le.FirstLink.decoration.setValue( ('CD_Association3_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('CD_Association3_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('CD_Association3_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('CD_Association3_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.arrowShape1=ATOM3Integer(11)
      ...
      self.le.SecondLink.decoration.setValue( ('CD_Association3_2ndLink', self.le.SecondLink))
