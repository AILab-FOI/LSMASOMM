# _ File: graph_GenericGraphEdge.py__________________________________________________________________________________
#  Graphical LINK for entity GenericGraphEdge, generated by ATOM3
# ______________________________________________________________________________________________________
from graphLink import *
from stickylink import *
from widthXfillXdecoration import *
class graph_GenericGraphEdge(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "GenericGraphEdge")
      ...
      self.le.FirstLink.decoration.setValue( ('GenericGraphEdge_1stLink', self.le.FirstLink))
      self.le.FirstSegment= widthXfillXdecoration()
      self.le.FirstSegment.width=ATOM3Integer(1)
      self.le.FirstSegment.fill=ATOM3String('purple')
      self.le.FirstSegment.stipple=ATOM3String('')
      self.le.FirstSegment.arrow=ATOM3Boolean()
      self.le.FirstSegment.arrow.setValue((' ', 1))
      self.le.FirstSegment.arrow.config = 0
      self.le.FirstSegment.arrowShape1=ATOM3Integer(4)
      self.le.FirstSegment.arrowShape2=ATOM3Integer(6)
      self.le.FirstSegment.arrowShape3=ATOM3Integer(4)
      self.le.FirstSegment.decoration=ATOM3Appearance()
      self.le.FirstSegment.decoration.setValue( ('GenericGraphEdge_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('GenericGraphEdge_Center', self.le))
      self.le.SecondSegment= widthXfillXdecoration()
      self.le.SecondSegment.width=ATOM3Integer(1)
      self.le.SecondSegment.fill=ATOM3String('purple')
      ...
      self.le.SecondSegment.decoration.setValue( ('GenericGraphEdge_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('GenericGraphEdge_2ndLink', self.le.SecondLink))
