# _ File: graph_AtomInheritance.py__________________________________________________________________________________
#  Graphical LINK for entity AtomInheritance, generated by ATOM3
# ______________________________________________________________________________________________________
from graphLink import *
from stickylink import *
from widthXfillXdecoration import *
class graph_AtomInheritance(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "AtomInheritance")
      ...
      self.le.FirstLink.decoration.setValue( ('AtomInheritance_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('AtomInheritance_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('AtomInheritance_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('AtomInheritance_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.arrowShape1=ATOM3Integer(9)
      ...
      self.le.SecondLink.decoration.setValue( ('AtomInheritance_2ndLink', self.le.SecondLink))
