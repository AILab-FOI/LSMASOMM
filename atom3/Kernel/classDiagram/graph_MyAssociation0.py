# _ File: graph_MyAssociation0.py__________________________________________________________________________________
#  Graphical LINK for entity MyAssociation0, generated by ATOM3
# ______________________________________________________________________________________________________
from graphLink import *
from stickylink import *
from widthXfillXdecoration import *
class graph_MyAssociation0(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "Class_information_not_available")
      ...
      self.le.FirstLink.decoration.setValue( ('Class_information_not_available_1stLink', self.le.FirstLink))
      self.le.FirstSegment= widthXfillXdecoration()
      self.le.FirstSegment.width=ATOM3Integer(0)
      ...
      self.le.FirstSegment.decoration.setValue( ('Class_information_not_available_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('Class_information_not_available_Center', self.le))
      self.le.SecondSegment= widthXfillXdecoration()
      self.le.SecondSegment.width=ATOM3Integer(0)
      ...
      self.le.SecondSegment.decoration.setValue( ('Class_information_not_available_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.decoration.setValue( ('Class_information_not_available_2ndLink', self.le.SecondLink))
