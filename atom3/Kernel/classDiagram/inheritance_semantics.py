# _ inheritance_semantics.py ____________________________________________________________________________
...
class inheritance_semantics (GGrule):

   def __init__(self, parent):
      GGrule.__init__(self, 1)
      self.LHS = ASG_ClassDiagramB(parent)

      self.obj26=AtomClass(parent)
      ...
      self.LHS.addNode(self.obj26)

      self.obj27=AtomClass(parent)
      ...
      self.LHS.addNode(self.obj27)

      self.obj28=AtomInheritance(parent)

      self.obj28.InheritanceName.setValue('')
      self.obj28.InheritanceConstraints.setActionFlags([ 1, 1, 1, 0])
      lcobj1 =[]
      self.obj28.InheritanceConstraints.setValue(lcobj1)
      self.obj28.InheritanceConstraints.setNone()
      self.obj28.InheritanceAppearance.setValue( ('None', self.obj28))
      ...
      self.RHS.addNode(self.obj30)

      self.obj31=AtomClass(parent)
      ...
      self.RHS.addNode(self.obj31)
   def condition(self, graphID, isograph, atom3i):
      return 1
      

   def action(self, graphID, isograph, atom3i):
      atom = self.graphRewritingSystem.parent   #atom root
