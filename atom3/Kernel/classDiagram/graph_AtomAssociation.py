# _ File: graph_AtomAssociation.py__________________________________________________________________________________
#  Graphical LINK for entity AtomAssociation, generated by ATOM3
# ______________________________________________________________________________________________________
from graphLink import *
from stickylink import *
from widthXfillXdecoration import *
class graph_AtomAssociation(graphLink):

   def __init__(self, xc, yc, semObject = None ):
      self.semObject = semObject
      self.semanticObject = semObject
      from linkEditor import *
      self.le=linkEditor(self,self.semObject, "AtomAssociation")
      ...
      self.le.FirstLink.decoration.setValue( ('AtomAssociation_1stLink', self.le.FirstLink))
      ...
      self.le.FirstSegment.decoration.setValue( ('AtomAssociation_1stSegment', self.le.FirstSegment))
      self.le.FirstSegment.decoration_Position=ATOM3Enum(['Up', 'Down', 'Middle', 'No decoration'],3,0)
      self.le.Center=ATOM3Appearance()
      self.le.Center.setValue( ('AtomAssociation_Center', self.le))
      ...
      self.le.SecondSegment.decoration.setValue( ('AtomAssociation_2ndSegment', self.le.SecondSegment))
      ...
      self.le.SecondLink.arrowShape3=ATOM3Integer(8)
      self.le.SecondLink.decoration=ATOM3Appearance()
      self.le.SecondLink.decoration.setValue( ('AtomAssociation_2ndLink', self.le.SecondLink))
