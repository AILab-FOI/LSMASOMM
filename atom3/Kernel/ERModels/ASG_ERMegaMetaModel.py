# __ASG_ERMegaMetaModel.py_____________________________________________________
from ASG import *
from ATOM3Type       import *
class ASG_ERMegaMetaModel(ASG, ATOM3Type):

   def __init__(self, parent= None, ASGroot = None):
      ASG.__init__(self, 'ERMegaMetaModel', ASGroot, ['ASG_ERMegaMetaModel' ,'relationship'])
   ...
   def show(self, parent, parentWindowInfo):
      ...
      #from ATOM3 import *
      #a = ATOM3 (parentWindowInfo , 'ERMegaMetaModel')
   ...
   def open(self, parent, topWindowParent):
       from ATOM3 import *
       a = ATOM3(topWindowParent, 'ERMegaMetaModel', 0, 1, self)
