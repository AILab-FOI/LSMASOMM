...
class AddRoles_GG_rule (GGrule):
   ...
   def __init__(self, parent):
      ...
      self.obj244=OrgUnit(parent)
      self.obj244.preAction( self.RHS.CREATE )
      ...
      self.RHS.addNode(self.obj244)
      self.obj244.postAction( self.RHS.CREATE )

      self.obj245=Role(parent)
      self.obj245.preAction( self.RHS.CREATE )
      ...
      # Add node to the root: self.RHS
      self.RHS.addNode(self.obj245)
      self.obj245.postAction( self.RHS.CREATE )

      self.obj246=Role(parent)
      self.obj246.preAction( self.RHS.CREATE )
      ...
      # Add node to the root: self.RHS
      self.RHS.addNode(self.obj246)
      self.obj246.postAction( self.RHS.CREATE )

      self.obj247=canHaveRole(parent)
      self.obj247.preAction( self.RHS.CREATE )
      ...
      # Add node to the root: self.RHS
      self.RHS.addNode(self.obj247)
      self.obj247.postAction( self.RHS.CREATE )
